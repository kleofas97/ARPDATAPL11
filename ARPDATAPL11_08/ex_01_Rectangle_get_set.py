...
class Rectangle:
    ...
    def __init__(self, bok1, bok2):
        # TODO - a jak chronic dane przy przypisaniu? podpowiedz: https://realpython.com/python-getter-setter/
        self._bok1 = bok1
        self._bok2 = bok2
    ...
    def bok1(self, new_bok):
        if isinstance(new_bok, (int, float))  and new_bok > 0:
            self._bok1 = new_bok
        else:
    ...
    def bok2(self, new_bok):
        if isinstance(new_bok, (int, float)) and new_bok > 0:
            ...
            print('Zla wartosc - bok2 niezmieniony')
